...
import { GalleryPreviewData } from "@/constants/models/AffirmationGategory";
...
const AffirmationPractice = () => {
  ...
  const [senteces, setSentences] = useState<string[]>([]);
      ...
      <AppGradient
        ...
        >
            <View className="h-full justify-center">
                <View className="h=4/5 justify-center mt-10">
                    {senteces.map((sentece, idx) =>(
